...
Tools:
	...
	•	Feel free to use either MVVM or MVP
	•	You can use any 3rd party library such as Retrofit, OkHttp, Dependency Injection Dagger/Hilt/Koin (Plus)
	•	You can access to the internet to check for any documentation you might need (When needed).
